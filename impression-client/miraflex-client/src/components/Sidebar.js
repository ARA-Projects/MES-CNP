...
const Sidebar = () => {
    ...
    const getData = async () => {
        fetching = true;
        const fetchedData = await fetchData("/mes/navbar/miraflex", "GET");
    ...
    const checkUser = async () => {
        fetching = true;
        const fetchedData = await fetchData("/mes/checkuser/miraflex", "GET");
        if (fetchedData.success) {
    ...
    return (
        <div className="sidebar">
            <img className="cms-img" src={miraflex} alt="cms" />
